...
import oldstuff.Network;

import java.io.*;

import presage.PresageConfig;
import presage.environment.AbstractPhysicalWorld;
...
//				wordCountTF.setText("" + countWordsInFile(file));
	...
	private PresageConfig makePresageConfig(){
		...
		// PhysicalWorld pworld = (PhysicalWorld) new example0.TestWorld(200, 300);
		...
		// Network network = (Network) new example0.TestNetwork();
