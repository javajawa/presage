...
import chainstore.plans.conversations.gameconv.GameConvCompetitorABlearner;
...
public class CompetitorABlearner implements Participant {	
	...
	@Element
	protected CompetitorABlearnerDataModel dm;


	public CompetitorABlearner(){}

	public CompetitorABlearner(String myId, String rolesString, long randomseed, double p_nc, double alpha,  double beta) {

		dm = new CompetitorABlearnerDataModel(myId, rolesString, CompetitorABlearner.class.getCanonicalName(), randomseed, p_nc, alpha,  beta);
	}

	public CompetitorABlearner(String myId, ArrayList<String> roles, long randomseed, double p_nc, double alpha,  double beta) {

		dm = new CompetitorABlearnerDataModel(myId, roles, CompetitorABlearner.class.getCanonicalName(), randomseed, p_nc,  alpha, beta);
	}
...
//		dm.timeOfLastCFP = dm.time;
	...
	public void initialise(EnvironmentConnector environmentConnector){
		...
		interpreter.addPlan(new GameConvCompetitorABlearner(dm, interpreter, null, null, null));
