...
public class MonopolistThresDataModel extends ChainDataModel {
...
//	protected long timeOfLastCFP = 0;
	...
	public MonopolistThresDataModel(String myId, ArrayList<String> roles, String playerClass, long randomseed, int threshold) {
...
//		this.cfpRate = cfpRate;
	...
	public MonopolistThresDataModel(String myId,  String myrolesString, String playerClass, long randomseed, int threshold) {
