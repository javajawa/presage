...
public class CompetitorDataModel extends ChainDataModel {
...
//	protected long timeOfLastCFP = 0;
	...
	public CompetitorDataModel(String myId, ArrayList<String> roles, String playerClass, long randomseed, int strategy) {
...
//		this.cfpRate = cfpRate;
	...
	public CompetitorDataModel(String myId,  String myrolesString, String playerClass, long randomseed, int strategy) {
