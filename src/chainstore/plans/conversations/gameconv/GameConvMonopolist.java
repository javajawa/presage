...
import chainstore.MonopolistDataModel;
...
public class GameConvMonopolist extends ConversationSingleFSM {

	MonopolistDataModel dm;
	...
	public GameConvMonopolist(MonopolistDataModel dm, Interpreter interpreter, String myKey, String theirId, String theirKey) {
...
//		
		...
		dm.myEnvironment.act( new MpstActResponse(car.getFrom(), dm.myId, car.getFromKey(), this.myKey, this.type, dm.getTime(), dm.myStrategy), dm.myId,dm.environmentAuthCode);
...
//	}
	...
	public ConversationSingle spawn(String myKey, Message msg) {
		// TODO Auto-generated method stub
		if (msg == null)
			return new GameConvMonopolist(dm, interpreter, myKey, null, null);
		
		return new GameConvMonopolist(dm, interpreter, myKey, msg.getFrom(), msg.getFromKey());
	}
