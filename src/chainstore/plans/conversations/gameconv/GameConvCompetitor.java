...
import chainstore.CompetitorDataModel;
...
public class GameConvCompetitor extends ConversationSingleFSM {

	CompetitorDataModel dm;
	...
	public GameConvCompetitor(CompetitorDataModel dm, Interpreter interpreter, String myKey, String theirId, String theirKey) {
	...
	public void chooseresponse(Input input){
		...
		dm.myEnvironment.act( new CptrActResponse(car.getFrom(), dm.myId, car.getFromKey(), this.myKey, this.type, dm.getTime(), dm.myStrategy), dm.myId,dm.environmentAuthCode);
...
//	}
	...
	public ConversationSingle spawn(String myKey, Message msg) {
		...
		if (msg == null)
			return new GameConvCompetitor(dm, interpreter, myKey, null, null);
		
		return new GameConvCompetitor(dm, interpreter, myKey, msg.getFrom(), msg.getFromKey());
	}
