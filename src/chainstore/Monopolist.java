...
import chainstore.plans.conversations.gameconv.GameConvMonopolist;
...
public class Monopolist implements Participant {
	...
	@Element
	protected MonopolistDataModel dm;


	public Monopolist(){}

	public Monopolist(String myId, String rolesString, long randomseed, int strategy) {

		dm = new MonopolistDataModel(myId, rolesString, Monopolist.class.getCanonicalName(), randomseed, strategy);
	}

	public Monopolist(String myId, ArrayList<String> roles, long randomseed, int strategy) {

		dm = new MonopolistDataModel(myId, roles, Monopolist.class.getCanonicalName(), randomseed, strategy);
	}
...
//		dm.timeOfLastCFP = dm.time;
	...
	public void initialise(EnvironmentConnector environmentConnector){
		...
		interpreter.addPlan(new GameConvMonopolist(dm, interpreter, null, null, null));
